                        ...
                        <div class="content">
                            ...
                            <div class="card card-plain mb-0">
                                ...
                                @if($cadastro->status == 1)
                                    <div class="row">
                                        <div class="col-sm-6 col-lg-12">
                                            <h4 class="pl-3 text-uppercase"><strong>Data da Certificação: </strong> {{ date('d/m/Y', strtotime($cadastro->data_certificado)) }}</h4>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-6 col-lg-12">
                                            <h4 class="pl-3 text-uppercase"><strong>Validade do Certificado: </strong> {{ date('d/m/Y', strtotime($cadastro->validade_certificado)) }}</h4>
                                        </div>
                                    </div>
                                @endif
                                ...
                                <div class="row">
                                    <div class="col-sm-6 col-lg-12">
                                        <h4 class="pl-3 text-uppercase"><strong>Porte da empresa: </strong><small> {{$cadastro->porte_empresa}}</small></h4>
                                    </div>
                                </div>
                                @if ($cadastro->cnae)
                                    <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-sm-6 col-lg-12">
                                        <h4 class="pl-3 text-uppercase"><strong>Produtos e Serviços : </strong><small> {{$cadastro->produtos}}</small></h4>
                                    </div>
                                </div>
